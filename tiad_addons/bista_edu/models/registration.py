...
#        if self.state_hide=='' or self.state_hide=='enquiry' or self.state_hide=='reg' or self.state_hide=='pending' or self.state_hide=='waiting_list':
    ...
    def reg_pay_manually(self,journal_id,bank_name=False,chk_num=False,sdate=False,exdate=False,cheque_pay=False,party_name=False):
		...
		print 'jounral_data==============================',jounral_data
        ...
        if not active_payforts.sha_in_key:
            ...
            mail_data = {
                ...
                'body_html': '<div><p>Dear, %s </p> </br>'
                             ...
                             ' please refer our school website here http://tiadubai.iqraeducation.net/admission-details/</p>'
                             ...
                             '<br/>Fax : +971 4 2644501' % (self.parent_name, self.enquiry_no, amount, link,)
            }
    ...
    def send_payfort_acd_pay_link(self):
        ...
        mail_data = {
            ...
            'body_html': '<div><p>Dear %s,</p> </br>'
                         ...
                         '<br/>http://www.indianacademydubai.com'
                         '<br/>Phone : +971 04 2646746, +971 04 2646733, Toll Free: 800 INDIAN (463426)'
                         '<br/>Fax : +971 4 2644501</p>' % (
                         self.parent_name, self.name, self.name, 2, data, cal_total_net_amount, link, 1, self.batch_id.name)
        }
        mail_id = mail_obj.create(mail_data)
        mail_obj.send(mail_id)
