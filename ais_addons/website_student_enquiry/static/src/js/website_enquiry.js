...
//                         );
        ...
        if (course != "") {
            ...
            if (date_of_birthday != ""){
				...
				$("#mob").css('border','1px solid #ccc')
                        ...
                        {
                            $("#trans_err").hide();
                            $("#transport_type").css('border','1px solid #ccc');
                        }
                        else
                        {
                            ...
                            $("#trans_err").show();
                            $("#msgtrans").hide();
                            $("#trans_err").css('color','#FF0000');
                            $("#trans_err").html("Please select one of the transport types");
                            return false;
                        }
    ...
    $('#stud_other_submit').click(function(){
        ...
        else
        {
            ...
            $("#m_em_er").html("Please enter email id");
            return false;
        }
