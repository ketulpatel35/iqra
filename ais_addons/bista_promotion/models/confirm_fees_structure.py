...
class confirm_fee_structure(models.Model):
    ...
    def send_mail_for_promoted_fee_structure(self):
        ...
        template_rec.write({'email_to': self.student_id.email, 'email_from': email_sender.smtp_user, 'email_cc': 'Erpemails_ais@iqraeducation.net'})
    ...
    def confirm_done_promoted_fee_structure(self):
        ...
        for fee_structure_line_rec in self.student_id.student_fee_line:
            fee_payable_data = {
                'name': fee_structure_line_rec.name,
