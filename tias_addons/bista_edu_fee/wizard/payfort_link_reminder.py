        ...
        if active_payforts.id:
            ...
            if not active_payforts.sha_in_key:
                ...
                mail_data={
                        ...
                        '<p>Best Regards<br/>'
                        ' <br/>Registrar,'
                        ' <br/>The Indian Academy, Sharjah<br/>http://tiasharjah.iqraeducation.net<br/>'
                        ' <br/>http://tiasharjah.iqraeducation.net'
                        ' <br/>Phone : +971 06 577 0949, 971 06 5770979'
                        '<br/>Fax : +971 06 5770900'%(parent.name,total_amount,2,table_date,link)
                    }
